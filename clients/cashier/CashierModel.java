  ...
  public void doBought()
  {
    ...
    try
    {
      ...
      {                                       // T
    	...
    	File dir = new File("record/" + sdf.format(today));
        dir.mkdir();
        File file = new File("record/" + sdf.format(today) + "/Order-" + number +".html");
        ...
        printWriter.println(getBasket().getDetails() + "<br>");
        printWriter.print("<a href='../" + sdf.format(today) + "-CollectionTable.html'>Go back</a>");
        printWriter.close();
        number = number + 1;
       //  Process order
