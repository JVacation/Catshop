...
public class Order implements OrderProcessing {
	 ...
	 * products are now being delivered to the collection desk
	 * 
	 * @param orderNum
	...
	/**
	 * Returns information about all the orders (there order number) in the order
	 * processing system This consists of a map with the following keys:
	 * 
	 * <PRE>
